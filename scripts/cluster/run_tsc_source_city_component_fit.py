#!/usr/bin/env python3
"""Fit one target city's source-city causal component bundle."""
...
def main() -> int:
    ...
    payload = run_source_city_component_fit(
        ...
        json.dumps(
            {
                "status": "PASS",
                "city": args.city,
                "source_city_groups": payload["source_city_groups"],
