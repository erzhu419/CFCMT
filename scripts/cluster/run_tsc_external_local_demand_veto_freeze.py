#!/usr/bin/env python3
"""Run the frozen v74 local-demand veto fit."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.out.exists():
        raise FileExistsError(f"refusing to overwrite v74 result: {args.out}")
    payload = run_local_demand_veto_freeze(
